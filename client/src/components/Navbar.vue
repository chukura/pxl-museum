<template>
  <header class="relative py-2 bg-yellow-200">
    <div class="flex items-center justify-between h-20 px-8 mx-auto max-w-7xl">
      ...
      >
        ...
        <router-link to="#search" class="relative h-6 group">
          <span
            class="
              relative
              z-10
          ...
          <span
            class="absolute top-0 right-0 w-full h-10 -mr-1 bg-black rounded-lg"
          ></span>
        </router-link>
      </nav>
...
.nav-link {
  @apply block text-left text-base font-medium text-gray-500 hover:text-gray-900 mt-2 md:mb-0;
}
</style>
